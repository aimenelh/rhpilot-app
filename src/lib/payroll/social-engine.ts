 ...
 * RH Pilot fournit explicitement la forme juridique et la date de calcul.
 * Les autres paramètres salarié seront branchés lorsqu'ils seront réellement
 * disponibles dans le dossier salarié. Aucun défaut métier n'est injecté.
 */
