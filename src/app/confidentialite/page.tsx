        ...
        <section className="mx-auto max-w-2xl px-6 pb-16">
          <Section title="1. Deux rôles distincts">
            ...
            <p>
              ...
              : c&apos;est nous qui décidons pourquoi et comment ces données
              sont utilisées.
            </p>
            <p>
              Pour les données que vous saisissez sur vos salariés (nom, date
              d&apos;embauche, contrat, visite médicale...), RH Pilot agit comme{" "}
              <strong className="font-semibold text-ink">sous-traitant</strong>.
              Votre entreprise reste responsable du traitement de ces données :
              c&apos;est vous qui décidez de les saisir, de les conserver ou de
              les supprimer, RH Pilot se contente de les stocker et de les
              organiser pour vous.
            </p>
          </Section>
          ...
          <Section title="2. Quelles données sont collectées">
            ...
            <p>
              <strong className="font-semibold text-ink">
                Questions posées au Copilote
              </strong>{" "}
              : le texte de votre question, et les données de
              l&apos;organisation strictement nécessaires pour y répondre.
            </p>
            <p>
              <strong className="font-semibold text-ink">
                Données de navigation
              </strong>{" "}
              : statistiques de fréquentation anonymisées, sans cookie, sans
          ...
          <Section title="4. Avec qui ces données sont partagées, et où">
            ...
            <p className="mt-4">
              Pour les prestataires basés aux États-Unis, le transfert de
              données est encadré soit par des clauses contractuelles types
              approuvées par la Commission européenne, soit par une
              certification dans le cadre du Data Privacy Framework
              UE-États-Unis, conformément aux exigences du RGPD.
            </p>
          </Section>
          ...
          <Section title="5. Combien de temps ces données sont conservées">
            ...
            <p>
              ...
              jours du côté d&apos;Anthropic, puis supprimées automatiquement de
              leurs systèmes.
            </p>
          </Section>
          ...
          <Section title="6. Vos droits">
            <p>
              ...
              de rectification, d&apos;effacement, de limitation et de
              portabilité de vos données, ainsi que du droit de vous opposer à
              leur traitement. Pour l&apos;exercer, écrivez-nous à
              l&apos;adresse indiquée ci-dessous. Vous pouvez aussi déposer une
              réclamation auprès de la CNIL (www.cnil.fr) si vous estimez que
          ...
          <Section title="9. Modifications de cette politique">
            <p>
              Cette page peut évoluer, notamment si un prestataire change ou si
              une nouvelle fonctionnalité traite des données différemment. La
              date de dernière mise à jour en haut de page reflète toujours la
              version en vigueur.
            </p>
          </Section>
