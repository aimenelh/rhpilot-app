      ...
      <section className="mt-7 overflow-hidden rounded-xl border border-surface-border bg-white">
        <div className="border-b border-surface-border px-5 py-5">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-brand-primary">Clôture de la paie</p>
              <h2 className="mt-1 text-lg font-semibold text-ink">Bulletins de salaire</h2>
              <p className="mt-1 max-w-2xl text-sm text-ink-soft">La période est verrouillée. La vue se concentre sur les documents de paie ; le détail du calcul reste conservé dans le dossier de la période.</p>
            </div>
            <span className="inline-flex w-fit shrink-0 items-center rounded-full bg-accent-teal/10 px-3 py-1.5 text-xs font-semibold text-accent-teal">Période verrouillée</span>
          </div>
        </div>
        <div className="p-5">
          ...
          <div className="mt-4 flex flex-col gap-3 border-t border-surface-border pt-4 sm:flex-row sm:items-center sm:justify-between">
            <div><p className="text-sm font-medium text-ink">Une correction est nécessaire ?</p><p className="mt-1 text-xs text-ink-faint">La réouverture crée un nouveau cycle de contrôle avant toute modification.</p></div>
