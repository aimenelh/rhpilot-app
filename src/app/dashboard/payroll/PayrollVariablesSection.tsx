    ...
    <section className="mt-7 rounded-xl border border-surface-border bg-white">
      <div className="border-b border-surface-border px-5 py-4">
        ...
        <p className="mt-1 text-xs text-ink-faint">
          Sélectionnez un élément reconnu par RH Pilot et saisissez son montant brut en euros. Le traitement réglementaire reste porté par la règle de paie validée.
        </p>
      </div>
                ...
                {employeeVariables.map((variable) => (
                  <div key={variable.id} className="flex flex-col gap-3 px-4 py-3 md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="flex items-center gap-4">
                      <p className="text-sm font-semibold text-ink">{variable.amount} {variable.unit === "EUR" ? "€" : variable.unit === "DAYS" ? "j" : variable.unit === "PERCENT" ? "%" : "h"}</p>
                      {canEdit && (
