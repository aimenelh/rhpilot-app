...
export function AskAboutOrganization({ aiEnabled = true }: { aiEnabled?: boolean }) {
  ...
  // Dès qu'une vraie réponse arrive du serveur, on l'ajoute à l'historique
  // affiché — useFormState ne garde que le dernier échange, donc c'est ce
  // useEffect qui fait office de mémoire de conversation côté client.
  useEffect(() => {
  ...
  return (
    <Card className="h-full border-brand-violet/25 bg-gradient-to-br from-brand-violet/[0.04] to-brand-blue/[0.04]">
