...
// Le rendu 3D ne peut pas se faire côté serveur (WebGL n'existe pas côté
// Node) — chargement dynamique, uniquement dans le navigateur, avec un
// petit indicateur de chargement pendant l'initialisation de la scène.
const OfficeScene = dynamic(() => import("./OfficeScene"), {
  ssr: false,
  loading: () => (
    <div className="flex h-[420px] w-full items-center justify-center rounded-2xl border border-surface-border bg-surface-subtle text-sm text-ink-faint">
          ...
          {step === 1 && (
            <div className="text-center">
              ...
              <div className="mx-auto mt-6 w-full max-w-xl">
                <OfficeScene found={found} onFound={markFound} revealed={revealed} />
              </div>
