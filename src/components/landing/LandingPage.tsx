    ...
    <div className="min-h-screen">
      ...
      <section className="relative flex min-h-[70vh] items-center justify-center overflow-hidden border-b border-surface-border bg-white px-6 py-24 sm:min-h-[76vh]">
        <Reveal>
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="font-display sr-only">Embauche, période d&apos;essai, visite médicale. Rien n&apos;est oublié.</h1>
            <p className="font-handwriting text-4xl leading-tight text-brand-primary sm:text-6xl lg:text-7xl">Des équipes RH<br />plus sereines</p>
            <p className="mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-ink-soft sm:text-xl">RH Pilot transforme chaque événement RH en plan d&apos;action clair, avec ses échéances et ses responsables.</p>
          </div>
        </Reveal>
      </section>
          ...
          <div className="relative mx-auto max-w-6xl">
            <div className="relative mx-auto max-w-5xl">
              <div className="overflow-hidden rounded-[1.25rem] border border-surface-border bg-white shadow-[0_30px_90px_rgba(15,23,42,0.12)]">
                <Image src="/marketing/dashboard.png" alt="Tableau de bord RH Pilot" width={1885} height={1030} className="w-full" priority />
              </div>
              <Image src="/illustrations/illu-copilote-hero.png" alt="" width={802} height={1274} className="pointer-events-none absolute -top-2 right-[13%] z-40 h-36 w-auto sm:-top-3 sm:right-[15%] sm:h-44 lg:h-48" />
            </div>
          </div>
        </Reveal>
      </section>
      ...
      <section className="relative py-16">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal><div className="text-center"><span className="text-xs font-semibold uppercase tracking-[0.15em] text-ink-faint">Voir RH Pilot en action</span><h2 className="mt-3 text-2xl font-semibold text-ink sm:text-3xl">Du problème détecté au parcours généré, en quelques clics.</h2></div></Reveal>
      ...
      <section className="relative border-y border-surface-border bg-white py-20">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal><div className="grid items-center gap-10 lg:grid-cols-[0.7fr_1.3fr]">
            <div className="max-w-xl"><span className="text-xs font-semibold uppercase tracking-[0.15em] text-ink-faint">Vos échéances</span><h2 className="mt-3 text-3xl font-semibold tracking-[-0.02em] text-ink sm:text-4xl">Les échéances n&apos;attendent pas.</h2><p className="mt-4 text-base leading-relaxed text-ink-soft">Un calendrier clair pour savoir ce qui arrive, ce qui est en retard et qui doit agir.</p></div>
            <div className="min-w-0"><img src="/marketing/calendar-landing.webp" alt="Calendrier RH Pilot avec les échéances et retards à surveiller" width={1200} height={600} className="h-auto w-full" loading="lazy" /></div>
          </div></Reveal>
        </div>
      </section>
      ...
      <section className="relative border-b border-surface-border bg-surface-subtle py-20">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal><div className="grid items-center gap-10 lg:grid-cols-[1.3fr_0.7fr]">
            <div className="order-2 min-w-0 lg:order-1"><img src="/marketing/notifications-landing.webp" alt="Notifications RH Pilot et envoi des résumés" width={1200} height={600} className="h-auto w-full" loading="lazy" /></div>
            <div className="order-1 max-w-xl lg:order-2"><span className="text-xs font-semibold uppercase tracking-[0.15em] text-ink-faint">Notifications</span><h2 className="mt-3 text-3xl font-semibold tracking-[-0.02em] text-ink sm:text-4xl">Une relance ne devrait jamais dépendre de votre mémoire.</h2><p className="mt-4 text-base leading-relaxed text-ink-soft">Les résumés partent au bon moment et l&apos;historique garde la trace de ce qui a déjà été envoyé.</p></div>
          </div></Reveal>
        </div>
      </section>
      ...
      <section id="copilote" className="relative border-b border-surface-border bg-white py-20">
        <div className="mx-auto max-w-6xl px-6">
          <Reveal><div className="grid items-center gap-10 lg:grid-cols-[0.7fr_1.3fr]">
            <div className="max-w-xl"><span className="text-xs font-semibold uppercase tracking-[0.15em] text-ink-faint">Copilote</span><h2 className="mt-3 text-3xl font-semibold tracking-[-0.02em] text-ink sm:text-4xl">Une question RH ? Demandez, il s&apos;en occupe.</h2><p className="mt-4 text-base leading-relaxed text-ink-soft">RH Pilot regarde vos données et vous répond dans le contexte de votre entreprise, sans vous faire chercher dans cinq écrans.</p></div>
            <div className="min-w-0"><img src="/marketing/copilot-landing.webp" alt="Copilote RH Pilot répond à une question RH à partir des données de l'entreprise" width={1200} height={640} className="h-auto w-full" loading="lazy" /></div>
          </div></Reveal>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden border-y border-surface-border bg-white py-16"><div className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-3"><div><p className="text-3xl font-bold text-ink">272 300</p><p className="mt-1 text-sm text-ink-faint">échéances RH générées</p></div><div><p className="text-3xl font-bold text-ink">45%</p><p className="mt-1 text-sm text-ink-faint">moins d&apos;oubli sur les tâches récurrentes</p></div><div><p className="text-3xl font-bold text-ink">60%</p><p className="mt-1 text-sm text-ink-faint">du temps administratif économisé</p></div></div></section>
