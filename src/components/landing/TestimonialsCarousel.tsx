...
function TestimonialCard({ quote, source, avatar, featured = false }: { quote: string; source: string; avatar: string; featured?: boolean }) {
  return (
    <div className={`rounded-2xl border p-6 ${featured ? "border-brand-primary/20 bg-brand-primary/[0.035] shadow-card" : "border-surface-border bg-white"}`}>
      ...
      <p className={`mt-6 break-words leading-relaxed text-ink ${featured ? "text-xl font-medium" : "text-sm"}`}>
    ...
    <>
      <section className="relative overflow-hidden border-y border-surface-border bg-white py-20 sm:py-24">
        <div className="mx-auto max-w-6xl px-6 sm:px-8">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-[1.05fr_1fr] lg:items-start">
            <Reveal variant="left">
