...
export const PAYROLL_CAPABILITIES: Record<string, PayrollCapability> = {
  ...
  employer: {
    ...
    intro: "La forme juridique, la date de création, le lieu de paie et le taux AT/MP font partie des paramètres transmis au calcul social.",
    ...
    variant: "employer",
    points: [
      { label: "Forme juridique", text: "La catégorie juridique de l’organisation est obligatoire pour le calcul social." },
