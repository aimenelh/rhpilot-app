  ...
  return (
    <div className="hidden items-center gap-10 lg:flex">
      <div className="relative h-[520px] w-[520px] shrink-0">
        ...
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-1/2 h-80 w-80 -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-primary opacity-25 blur-3xl"
        />
        <div
          aria-hidden
          className="pointer-events-none absolute left-1/2 top-1/2 h-64 w-64 -translate-x-1/2 -translate-y-1/2 animate-pulse rounded-full border border-brand-primary/20"
        />

        {/* Points lumineux */}
        <span aria-hidden className="pointer-events-none absolute left-[18%] top-[36%] h-1.5 w-1.5 rounded-full bg-brand-primary/60 blur-[1px]" />
        <span aria-hidden className="pointer-events-none absolute right-[16%] top-[64%] h-2 w-2 rounded-full bg-brand-primary-dark/60 blur-[1px]" />
        ...
        <span aria-hidden className="pointer-events-none absolute right-[8%] top-[48%] h-1 w-1 rounded-full bg-brand-primary/50 blur-[1px]" />
        <span aria-hidden className="pointer-events-none absolute left-[8%] top-[62%] h-1.5 w-1.5 rounded-full bg-brand-primary-dark/40 blur-[1px]" />
        <span aria-hidden className="pointer-events-none absolute right-[24%] top-[88%] h-1 w-1 rounded-full bg-accent-teal/50 blur-[1px]" />
        <span aria-hidden className="pointer-events-none absolute right-[30%] top-[8%] h-1 w-1 rounded-full bg-brand-primary/40 blur-[1px]" />
        ...
        <svg
          ...
          className="pointer-events-none absolute inset-0 h-full w-full text-brand-primary/30"
        >
          ...
          <circle r="0.9" fill="currentColor" className="text-brand-primary">
            <animateMotion dur="2.6s" begin="0s" repeatCount="indefinite">
              <mpath href="#hero-line-1" />
            </animateMotion>
          </circle>
          <circle r="0.9" fill="currentColor" className="text-brand-primary-dark">
          ...
          <circle r="0.7" fill="currentColor" className="text-brand-primary">
        ...
        <div className="absolute left-1/2 top-1/2 z-30 w-60 -translate-x-1/2 -translate-y-1/2 rotate-[-2deg] sm:w-64">
          <Card className="shadow-[0_35px_70px_-20px_rgba(46,111,242,0.35)] ring-1 ring-brand-primary/10">
        ...
        >
          <div className="hero-float-b">
            <Card compact className="shadow-sm">
              <div className="flex items-center gap-2">
                <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-brand-primary-dark/10 text-brand-primary-dark">
                  <Stethoscope size={16} />
                </span>
                <div className="min-w-0">
        ...
        >
          <div className="hero-float-c">
            <Card compact className="shadow-sm">
              <div className="flex items-center gap-2">
                <FileText size={16} className="shrink-0 text-brand-primary" />
                <div className="min-w-0">
        ...
        >
          <Card compact className="shadow-lg">
            ...
            <div className="mt-1.5 grid grid-cols-4 gap-1.5 text-center">
              ...
              <div>
                <p className="text-sm font-semibold text-brand-primary">12</p>
